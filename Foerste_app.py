        ...
        return html.Div([
                        html.Div([
                                  html.Div([html.Img(src='https://www.dropbox.com/s/tewrjollx6up3lr/beskar2.jpg?raw=1',
                                                     style=dict(width='200px', height='300px')
                                                  ),
                                            html.Div([
                                                      html.H4(id='name',
...
dataSkills=dict(data=[go.Scatterpolar(
                          r = [40, 35, 38, 25, 35, 10, 40],
                          theta = ['Machine Learning', 'Statistics  ', "Mathematics", "Agile Development", "Programming", "Economics", 'Machine Learning'],
                          fill = 'toself',
...
codeSkills=dict(data=[go.Scatterpolar(
                          r = [12, 11, 30, 35, 6, 6, 30, 12],
                          theta = ['SAS','F Sharp', 'Python', 'R', 'MatLab', 'SQL', 'Java', 'SAS'],
                          fill = 'toself',
...
lanSkills=dict(data=[go.Scatterpolar(
                          r = [10, 45, 50, 10],
...
@app.callback(Output('my-skills','figure'),
             [Input('data-skills', 'n_clicks'),
              ...
              Input('lan-skills', 'n_clicks'),
              Input('lan-skills', 'n_clicks_timestamp')])
def update_skills(button_1_clicks, button_1_timestamp, button_2_clicks, button_2_timestamp,button_3_clicks, button_3_timestamp):
    if (button_1_timestamp == button_2_timestamp) and (button_1_timestamp == button_3_timestamp) and (button_2_timestamp == button_3_timestamp):
        return dataSkills
    elif (button_1_timestamp > button_2_timestamp) and (button_1_timestamp > button_3_timestamp):
        return dataSkills
    elif (button_2_timestamp > button_1_timestamp) and (button_2_timestamp > button_3_timestamp):
        return codeSkills
    elif (button_3_timestamp > button_1_timestamp) and (button_3_timestamp > button_2_timestamp):
        return lanSkills
...
@app.callback(Output('buttons','children'),
             [Input('data-skills', 'n_clicks'),
              ...
              Input('lan-skills', 'n_clicks'),
              Input('lan-skills', 'n_clicks_timestamp')])
def update_buttons_skills(button_1_clicks, button_1_timestamp, button_2_clicks, button_2_timestamp,button_3_clicks, button_3_timestamp):
    if (button_1_timestamp == button_2_timestamp) and (button_1_timestamp == button_3_timestamp) and (button_2_timestamp == button_3_timestamp):
        return html.Div([
